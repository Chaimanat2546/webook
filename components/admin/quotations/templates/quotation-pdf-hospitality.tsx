...
export function HospitalityQuotationPdf({
  ...
  const sellerBlock = payload.layout.config.blocks.find(
    (block) => block.id === "seller",
  );
  const metadataBlock = payload.layout.config.blocks.find(
    (block) => block.id === "documentMetadata",
  );
      ...
      <Page size="A4" style={styles.page} wrap>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.titleBox}>
            ...
            <Text style={[styles.title, { color: theme.primary }]}>QUOTATION</Text>
            <Text style={[styles.thaiTitle, { color: theme.muted }]}>
              ใบเสนอราคา
            </Text>
          </View>
        </View>
        <View
          style={
            metadataIsLeft
              ? [
                  styles.row,
                  { flexDirection: "row-reverse", paddingVertical: 8 },
                ]
        ...
        <View style={styles.row}>
          <View
            style={[
              styles.recipient,
              { backgroundColor: theme.light, borderColor: theme.muted },
            ]}
            data-hospitality-recipient
          >
            <Text style={[styles.bold, { color: theme.dark }]}>สำหรับ</Text>
        ...
        <View style={styles.table}>
          <Text style={[styles.tableLabel, { color: theme.dark }]}>
        ...
        >
          ...
          >
            <Text style={styles.bold}>สรุปการชำระ</Text>
            <Total
              label="มูลค่ารวม"
              styles={themedSharedStyles}
        ...
        <View
          style={[styles.footer, { borderTopColor: theme.muted }]}
          data-pdf-seller-footer
        >
          <Text style={[styles.bold, { color: theme.dark }]}>
            {payload.seller.name}
          </Text>
          ...
          {sellerContact ? <Text>ผู้ติดต่อ: {sellerContact}</Text> : null}
        </View>
      </Page>
    </Document>
  );
