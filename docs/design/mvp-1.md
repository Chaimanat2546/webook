...
- Top app bar with WeBooks label, current section, hamburger menu, and compact account/notification affordance
...
- Top app bar with WeBooks label, current section, hamburger menu, and compact account affordance
