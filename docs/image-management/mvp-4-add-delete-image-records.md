...
- MVP นี้ใช้ operation-based UI: เลือกรูปแล้วอัปโหลดผ่าน queue ทันที และลบรูปผ่าน confirmation แยกแต่ละ operation
...
- รูปใหม่ upload ไป Cloudflare R2 จาก queue แล้วเพิ่ม record ใน `images`
