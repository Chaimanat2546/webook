...
ฉบับย่อสำหรับผู้ดูแลระบบ WeBooks<br>
ปรับปรุงล่าสุด: 4 สิงหาคม 2026
...
### 2.1 เลือกเทมเพลตเอกสาร

กด **เลือกเทมเพลต** ข้างปุ่ม **ตั้งค่ารูปแบบเอกสาร** แล้วเลือกหนึ่งในสามแบบ:

- **Current** ใช้รูปแบบสี Indigo เดิม เหมาะเมื่อจำเป็นต้องรักษาหน้าตาเอกสารเดิม
- **Hospitality** ใช้สีเขียวเข้มและทองอ่อน เหมาะกับเอกสารที่พักและบริการ
- **Corporate** ใช้สีน้ำเงินเข้มและเทา เหมาะกับเอกสารจัดซื้อหรือองค์กร

ป้าย **กำลังใช้** คือแบบของใบเสนอราคาในหน้าที่กำลังแก้ไข และป้าย
**ค่าเริ่มต้นของบัญชี** คือแบบที่ใบใหม่จะเริ่มต้นใช้

- กด **ใช้เฉพาะใบเสนอราคานี้** เพื่อเปลี่ยนแบบของร่างปัจจุบัน แล้วกดบันทึกใบเสนอราคาเพื่อเก็บค่าไว้
- กด **ใช้และบันทึกเป็นค่าเริ่มต้น** เพื่อใช้กับร่างปัจจุบันและกำหนดเป็นค่าเริ่มต้นสำหรับใบใหม่ในอนาคต ใบที่บันทึกแล้วจะไม่เปลี่ยนตาม

การเปลี่ยนเทมเพลตไม่แก้ข้อมูลลูกค้า รายการ ยอดคำนวณ ช่องทางชำระเงิน ข้อมูลรับรอง หรือการตั้งค่าการแสดงผลเอกสาร ขณะดูตัวอย่างจะแสดงเทมเพลตของร่างล่าสุดทันที แต่พิมพ์ ดาวน์โหลด PDF และลิงก์ Public ใช้เทมเพลตของข้อมูลที่บันทึกล่าสุด

การจัดวางแบบลากวางหรือแก้บล็อกเองยังไม่มีในเวอร์ชันนี้
