...
- **4** ประเภทสำนักงานใหญ่หรือสาขา
- **5** ที่อยู่ผู้ขาย
- **6** ช่องทางติดต่อ

กรอกชื่อ ที่อยู่ และเลขภาษีให้ครบ เลขสาขาจะแสดงเมื่อเลือก **สาขา** จากนั้นกดบันทึก ข้อมูลนี้จะถูกคัดลอกลงใบใหม่เป็น Snapshot และยังแก้เฉพาะใบได้
...
- **5** ตั้งค่าส่วนลดหรือ VAT รายการ
...
- ลูกค้า: ชื่อและที่อยู่
- เอกสาร: วันที่ออก จำนวนวัน เรื่องหรือชื่องาน และเลขอ้างอิงถ้ามี
- รายการ: ชื่อ จำนวน ราคาต่อหน่วย และหน่วยถ้ามี
- หมายเหตุ: หมายเหตุบนเอกสารจะแสดงให้ลูกค้าเห็น ส่วนหมายเหตุภายในไม่แสดง

ระบบคำนวณส่วนลด VAT ภาษีหัก ณ ที่จ่าย และยอดชำระให้อัตโนมัติ จำนวนต้องมากกว่า 0 และราคาห้ามติดลบ
...
การแก้ไขใช้เลขที่เอกสารเดิม การลบเป็น Soft Delete และทำให้ลิงก์ Public เปิดไม่ได้ เลขที่เอกสารเดิมจะไม่นำกลับมาใช้ใหม่
