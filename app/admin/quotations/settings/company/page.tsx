...
export default async function CompanyProfilePage() {
  ...
  return <div className="mx-auto max-w-5xl space-y-4"><Link className="text-sm underline" href="/admin/quotations">กลับไปใบเสนอราคา</Link><div><h1 className="text-xl font-semibold">ข้อมูลผู้ขายหลัก</h1><p className="text-sm text-muted-foreground">ใบเสนอราคาใหม่จะคัดลอกข้อมูลนี้เป็นสำเนาที่แก้ไขได้</p></div><CompanyProfileForm banks={banks} initialPaymentMethods={paymentMethods} initialSeller={seller} /></div>;
}
