-- Service-role cannot read auth.users. The existing booking_logs performed_by FK
-- validates actor existence; the web guard supplies its verified session identity.
