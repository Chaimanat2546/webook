-- Server-side Supabase calls originate from the web runtime, so their native
-- User-Agent and IP describe the runtime instead of the browser. The web
-- server forwards the original request metadata in these private log headers.
